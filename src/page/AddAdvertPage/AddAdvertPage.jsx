...
//         return axios.post(urlImgUpload, formData, {
//           headers: {
//             accept: `*/*`,
//             'Content-Type': 'multipart/form-data',
//             Authorization: `Bearer ${token}`,
...
//       })
//       .then(res => {
//         const urlPatchStatusProduct = `https://back.komirka.pp.ua/api/v1/private/product/${res.data.reference}/ACTIVE?period=30`;
//         console.log(token);
//         return axios.patch(
...
export default function AddAdvertPage() {
  ...
  const onSubmit = data => {
    const token = JSON.parse(localStorage.getItem('user')).authenticationToken;
    const url = `https://7051-37-115-217-3.ngrok-free.app/api/v1/private/product/create`;
    const body = {
      categoryName: translationCategory(data.category),
      city: data.city,
      productTitle: data.titel,
    ...
    axios
      ...
      .then(res => {
        const URL = `https://7051-37-115-217-3.ngrok-free.app/api/v1/private/product/${res.data.reference}`;
        console.log(body);
        return axios.patch(URL, body, {
          headers: {
            accept: `*/*`,
      ...
      .then(res => {
        const urlImg = `https://7051-37-115-217-3.ngrok-free.app/api/v1/private/product/${res.data.reference}/image`;
        return axios.post(urlImg, formData, {
          headers: {
            accept: `*/*`,
            'Content-Type': 'multipart/form-data',
      ...
      .then(res => {
        const urlImgUpload = `https://7051-37-115-217-3.ngrok-free.app/api/v1/private/product/image/${res.data.id}`;
        return axios.post(urlImgUpload, formData, {
          headers: {
            accept: `*/*`,
            'Content-Type': 'multipart/form-data',
      ...
      .then(res => {
        const urlPatchStatusProduct = `https://7051-37-115-217-3.ngrok-free.app/api/v1/private/product/${res.data.reference}/ACTIVE?period=30`;
        console.log(token);
        return axios.patch(
          urlPatchStatusProduct,
          {},
